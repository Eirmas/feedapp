<template>
  <Main>
    <h1 class="text-h2 mb-4">Privacy Policy</h1>
    <p class="mb-4">Last updated: October 15, 2023</p>
    <p class="mb-4">
    ...
    <h4 class="text-body-large-bold mb-4">Interpretation</h4>
    <p class="mb-4">
    ...
    <h4 class="text-body-large-bold mb-4">Definitions</h4>
    ...
    <ul class="list-disc list-inside mb-4">
      ...
      <li>
        <strong>Website</strong> refers to FeedApp, accessible from
        <a href="https://feedapp.no/" rel="external nofollow noopener" target="_blank">https://feedapp.no/</a>
      </li>
      <li>
    ...
    <h3 class="mb-2">Collecting and Using Your Personal Data</h3>
    <h4 class="text-body-large-bold mb-4">Types of Data Collected</h4>
    <h4 class="text-body-bold">Personal Data</h4>
    <p class="mb-4">
    ...
    <h4 class="text-body-bold">Usage Data</h4>
    ...
    <h4 class="text-body-bold">Information from Third-Party Social Media Services</h4>
    <p class="mb-4">The Company allows You to log in to use the Service through the following Third-party Social Media Services:</p>
    <ul class="list-disc list-inside mb-4">
      <li>Google</li>
    </ul>
    <p class="mb-4">
    ...
    <h4 class="text-body-bold">Tracking Technologies and Cookies</h4>
    <p class="mb-4">
    ...
    <ul class="list-disc list-inside mb-4">
      ...
      <li>
        ...
        <p class="mb-4">Administered by: Us</p>
        <p class="mb-4">Purpose: These Cookies identify if users have accepted the use of cookies on the Website.</p>
      </li>
      <li>
    ...
    <h4 class="text-body-large-bold mb-4">Use of Your Personal Data</h4>
    ...
    <h4 class="text-body-large-bold mb-4">Retention of Your Personal Data</h4>
    <p class="mb-4">
    ...
    <h4 class="text-body-large-bold mb-4">Transfer of Your Personal Data</h4>
    <p class="mb-4">
    ...
    <h4 class="text-body-large-bold mb-4">Delete Your Personal Data</h4>
    <p class="mb-4">
    ...
    <h4 class="text-body-large-bold mb-4">Disclosure of Your Personal Data</h4>
    <h4 class="text-body-bold">Business Transactions</h4>
    <p class="mb-4">
    ...
    <h4 class="text-body-bold">Law enforcement</h4>
    <p class="mb-4">
    ...
    <h4 class="text-body-bold">Other legal requirements</h4>
    ...
    <h4 class="text-body-large-bold mb-4">Security of Your Personal Data</h4>
    <p class="mb-4">
    ...
    <h3 class="mb-2">Children's Privacy</h3>
    <p class="mb-4">
    ...
    <h3 class="mb-2">Changes to this Privacy Policy</h3>
    <p class="mb-4">
    ...
    <ul class="list-disc list-inside mb-4">
      <li>By email: eirik.maaseidvaag@gmail.com</li>
    </ul>
  </Main>
</template>
